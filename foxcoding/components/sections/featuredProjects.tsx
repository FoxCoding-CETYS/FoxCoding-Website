...
const items: Item[] = [
  ...
  },
  {
    ...
    liveUrl: "https://drive.google.com/file/d/1rEwyxak9DFuKLcjw_3K8qbte5Kstr1BJ/view?usp=sharing",
  },
  {
    title: "Social Graphs",
    status: "Active",
...
export function FeaturedProjects(){
    ...
    return(
        <div className="flex flex-col mx-auto gap-10 md:gap-20 px-6 py-10 md:py-16 w-full md:w-7/8">
            ...
            <CustomButton variant = "secondary" size = "lg" className="w-1/2 md:w-1/3 mx-auto my-auto">Learn More</CustomButton>
