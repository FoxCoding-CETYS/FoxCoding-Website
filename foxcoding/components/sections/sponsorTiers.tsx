      ...
      "Entrega de reconocimiento.",
        ...
        <div className="lg:col-span-2">
          <SponsorsCard
            ...
            variant="silver"
            range="$2,000 - $4,999"
            description={[      "Todo lo del tier Bronze",
      "Logotipo en camisetas de competencia.",
      "Oportunidades para colaboración.",
      "Mención en artículos VOCETYS.",]}
          />
        ...
        <div className="lg:col-span-2">
          <SponsorsCard
            ...
            variant="gold"
            range="$5,000 - $9,999"
            description={[      "Todo lo del tier Plata",
      "Acceso preferente a vinculación con talento FoxCoding.",
      "Oportunidad de ofrecer una charla técnica.",]}
          />
        </div>
        <div className="lg:col-span-3 lg:col-start-1">
          <ElectricBorder         color="#E5E4E2"
        speed={1}
        chaos={0.5}
        thickness={2} style={{ borderRadius: 25 }}>
          <SponsorsCard
            title="PLATINUM"
            variant="platinum"
            range="$10,000+"
            description={[      "Todo lo del tier Oro",
      "Mención en competencias organizadas por el equipo.",
      "Logo en lugar preferente en todo material oficial.",]}
          />
          </ElectricBorder>
        ...
        <div className="lg:col-span-3">
          ...
          <SponsorsCard
            ...
            description={[      "Logo en la sección 'Aliados Tecnológicos' del sitio web.",
      "Mención especial en talleres donde se use su herramienta.",
      "Certificado digital como 'Colaborador de FoxCoding'."]}
          />
