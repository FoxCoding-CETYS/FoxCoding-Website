...
export default function Home() {
  return (
    <div className="flex flex-col gap-2 md:gap-6 w-full overflow-hidden">
      <div className="flex relative bg-background w-full text-primary flex-col text-3xl md:text-5xl font-normal items-center justify-center text-center px-6">
        <div className="absolute inset-0 pointer-events-none opacity-35">
          <LetterGlitch
            glitchColors={["#F7D13B", "#18181B"]}
            glitchSpeed={0.9}
            centerVignette={true}
            outerVignette={true}
            smooth={true}
            characters="FOXCODING"
          />
        </div>
      ...
      <CustomButton
        variant="outline"
        size="lg"
        className="mx-auto my-auto mb-10"
      >
